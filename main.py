...
#     prompt = "I want a good headset in range of 1000EGP."
...
#         for attr in ['agent_name', 'name', 'sender']:
#             if hasattr(ev, attr) and getattr(ev, attr):
#                 return getattr(ev, attr)
        
#         # Try to get from source
#         if hasattr(ev, 'source') and hasattr(ev.source, 'agent_name'):
#             return ev.source.agent_name
